...
UR_WARN_UNUSED_RESULT bytes_data_t *bytes_new(const uint8_t *data, size_t len);
void bytes_free(bytes_data_t *bytes);

// Registry item interface for Bytes
UR_WARN_UNUSED_RESULT registry_item_t *
bytes_to_registry_item(bytes_data_t *bytes);
bytes_data_t *bytes_from_registry_item(registry_item_t *item);

// CBOR conversion functions
UR_WARN_UNUSED_RESULT cbor_value_t *bytes_to_data_item(registry_item_t *item);
UR_WARN_UNUSED_RESULT registry_item_t *
bytes_from_data_item(cbor_value_t *data_item);

// Convenience functions
UR_WARN_UNUSED_RESULT uint8_t *bytes_to_cbor(bytes_data_t *bytes,
                                             size_t *out_len);
UR_WARN_UNUSED_RESULT bytes_data_t *bytes_from_cbor(const uint8_t *cbor_data,
                                                    size_t len);

...
UR_WARN_UNUSED_RESULT uint8_t *registry_item_to_cbor(registry_item_t *item,
                                                     size_t *out_len);
 ...
 */
UR_WARN_UNUSED_RESULT registry_item_t *
registry_item_new(registry_type_t *type, void *data, to_data_item_fn to_fn,
 ...
 */
UR_WARN_UNUSED_RESULT void *
registry_item_unwrap_from_cbor(const uint8_t *cbor_data, size_t len,
                               from_data_item_fn from_fn);
